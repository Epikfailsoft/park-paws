      ...
      <div className="flex min-h-screen flex-col bg-background safe-top">
        <div className="px-6 pt-8 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display text-xl font-bold text-foreground">Hoş Geldin!</h1>
              <p className="text-sm text-muted-foreground">Profilini oluşturalım</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 px-6">
          ...
          <button
            onClick={() => { if (ownerPhoto) handleOwnerPhotoUpload(); else setStep(2); }}
