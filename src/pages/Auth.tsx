...
import { Dog, Mail, Lock, User, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="flex-1 px-6">
        <div className="mx-auto max-w-sm">
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-border bg-card py-3 font-medium text-foreground transition-all hover:bg-secondary"
            >
