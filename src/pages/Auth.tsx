        ...
        <div className="mx-auto max-w-sm">
          ...
          <div className="space-y-3 mb-5">
            <button type="button" onClick={() => handleSocialLogin('google')} disabled={loading}
              className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-border bg-card py-3.5 font-medium text-foreground transition-all hover:bg-secondary disabled:opacity-50">
